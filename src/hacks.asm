...
%define         TYPE_NPC            0x110F88D8
%define         TYPE_DOOR           0x110FDDD8
%define         TYPE_PLAYER         0x110E8B50

%define         OFFSET_ALARMS       0x0009BC61
%define         OFFSET_HEALTH       0x003F07C8
%define         OFFSET_NOISE        0x00417E5D
%define         OFFSET_VISIBILITY   0x0027F12C
