...
{
    //// Doesnt work
    // strcpy_s(hackMenu[GOD_MODE].name, strlen("1: God Mode"), "1: God Mode");
    // strcpy_s(hackMenu[GHOST_MODE].name, strlen("2: Ghost Mode"), "2: Ghost Mode");
    // strcpy_s(hackMenu[SUPER_WEAPONS].name, strlen("3: Super Weapons"), "3: Super Weapons");
    // strcpy_s(hackMenu[DISABLE_ALARMS].name, strlen("4: Disable Alarms"), "4: Disable Alarms");
    // strcpy_s(hackMenu[DISABLE_ENEMIES].name, strlen("5: Disable Enemies"), "5: Disable Enemies");
    // strcpy_s(hackMenu[UNLOCK_ALL_DOORS].name, strlen("6: Unlock All Doors"), "6: Unlock All Doors");

    // Unsafe but there is no user input so idc
